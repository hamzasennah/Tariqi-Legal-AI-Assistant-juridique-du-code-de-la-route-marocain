...
\author{Projet Python, RAG et FastAPI}
\date{2026}
...
\begin{itemize}[leftmargin=1.2cm]
    ...
    \item Fournir une application web FastAPI utilisable et une interface CLI.
\end{itemize}
...
\begin{lstlisting}
tariqi-legal-ai/
|-- app/                  Application FastAPI, templates et fichiers statiques
|-- data/
...
\subsection{Lancer l'application web}
